...
public class WebStranitsa {
    ...
    private SelenideElement buyCreditButton = $$(".button__text")
            .find(exactText("Купить в кредит"));

    private SelenideElement cardNumberField = $$(".input__inner")
            .findBy(text("Номер карты"))
            .$(".input__control");
    ...
    private SelenideElement cardClientField = $$(".input__inner")
            .findBy(text("Владелец"))
            .$(".input__control");

    private SelenideElement cvcOrCvvField = $$(".input__inner")
            .findBy(text("CVC/CVV"))
            .$(".input__control");
    ...
    public void setCardOwner(String owner) {
        cardClientField.setValue(owner);
    }
